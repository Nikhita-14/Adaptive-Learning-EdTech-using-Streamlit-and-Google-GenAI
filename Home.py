    ...
    if grade_num <= 5:
        ...
        if stream == "Science":
            subjects = ["English", "Mathematics", "Physics", "Chemistry", "Biology",
                    "Applied Mathematics", "Informatics Practices", "Psychology", "Fine Arts"]
        elif stream == "Commerce":
            subjects = ["English", "Economics", "Accountancy", "Business Studies",
                     "Applied Mathematics", "Informatics Practices", "Psychology", "Fine Arts"]
        else:
            subjects = ["English", "History", "Political Science", "Geography", "Sociology",
                       "Applied Mathematics", "Informatics Practices", "Psychology", "Fine Arts"]
